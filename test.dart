...
final class GrammarParser extends _PegParser<ParserGenerator> {
  ...
  late final f2p = () {
    if (this.pos case var mark) {
      if (matchPattern(_regexp.$3) case var $0) {
        if (matchPattern(_regexp.$2) case var $1?) {
          return ($0, $1);
        }
      }
      this.pos = mark;
  ...
  late final f2s = () {
    if (this.pos case var mark) {
      if (this.matchPattern(_string.$61) case null) {
        this.pos = mark;
        if (this.pos < this.buffer.length) {
          if (this.buffer[this.pos++] case var $) {
            return $;
  ...
  late final f2t = () {
    if (this.pos case var mark) {
      if (matchPattern(_regexp.$4) case var _0?) {
        if ([_0] case var _l1) {
          for (;;) {
            if (this.pos case var mark) {
              if (matchPattern(_regexp.$4) case var _0?) {
    ...
    if (this.pos case var mark) {
      ...
      if (this.apply(this.rn) case var type?) {
        if (this.fs() case var $1) {
          if (this.matchPattern(_string.$66) case var $2?) {
            if (this.apply(this.rr) case var parameters?) {
