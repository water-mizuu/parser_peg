...
final class AstGrammarParser extends _PegParser<Object> {
  ...
  Object? r2() {
    if (this._mark() case var _mark) {
      if (this.f1g() case (var $0 && var outer_decorator)) {
        if (this.f1h() case (var $1 && var type)) {
      ...
      this._recover(_mark);
      if (this.f1w() case (var $0 && var decorator)) {
  ...
  Object? r5() {
    if (this.apply(this.r6) case var _0?) {
      if ([_0] case (var $0 && var body && var _l1)) {
        ...
        if (this.f25() case (var $1 && var chosen)) {
          return ($0, $1);
        }
      }
    }
    ...
    if (this._mark() case var _mark) {
      ...
      if (this.fs() case (var $0 && null)) {
        ...
        if (this.ft() case var $1?) {
          if (this.apply(this.r3) case (var $2 && var choice)?) {
  ...
  Object? rn() {
    if (this.apply(this.rt) case (var $0 && var base)?) {
      if (this.ft() case var $1?) {
        if (this.f45() case (var $2 && var args)?) {
          if (this.fu() case var $3?) {
            return ($0, $1, $2, $3);
          }
        }
