  ...
  Object? r5() {
    if (this.apply(this.r6) case var _0?) {
      if ([_0] case (var $0 && var body && var _l1)) {
        ...
        if (this.f1j() case (var $1 && var chosen)) {
          return ($0, $1);
        }
      }
    }
