...
final class PegParser extends _PegParser<ParserGenerator> {
  ...
  String? f1q() {
    if (this.f2w() case var base?) {
      if (this.f11() case _?) {
        if (this.f1r() case var arguments?) {
          if (this.f12() case _?) {
