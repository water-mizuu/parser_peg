...
final class PegParser extends _PegParser<ParserGenerator> {
  ...
  late final f9 = () {
    if (this.pos case var mark) {
      ...
      this.pos = mark;
      if (this.pos case var from) {
        if (this.f11() case (var $0 && var l)?) {
          if (this.matchPattern("-") case var $1?) {
            if (this.f11() case (var $2 && var r)?) {
              if (($0, $1, $2) case var $) {
                if (this.pos case var to) {
    ...
    if (this.pos case var mark) {
      if (this.pos case var from) {
        if (this.f21() case var $0?) {
          if (this.f17() case (var $1 && var name)) {
      ...
      this.pos = mark;
      if (this.pos case var from) {
        if (this.f17() case (var $0 && var name)) {
          if (this.f52() case var $1?) {
        ...
        if (this.apply(this.r8) case (var $0 && var sequence)?) {
          if (this.f54() case var $1?) {
            if (this.f53() case var $2?) {
              if (this.f52() case var $3?) {
                if (this.f69() case var $4) {
                  if (this.apply(this.r15)! case (var $5 && var code)) {
                    if (this.f69() case var $6) {
                      if (this.f51() case var $7?) {
        ...
        if (this.apply(this.r9) case var _0?) {
          if ([_0] case (var $0 && var body && var _loop2)) {
            ...
            if (this.f46() case var $1?) {
              if (this.f19() case (var $2 && var number)?) {
                if (($0, $1, $2) case var $) {
                  if (this.pos case var to) {
  ...
  Node? r9() {
    if (this.pos case var mark) {
      if (this.pos case var from) {
        if (this.f17() case (var $0 && var identifier)?) {
          if (this.matchPattern(":") case var $1?) {
            if (this.f69() case var $2) {
  ...
  Node? r10() {
    if (this.pos case var mark) {
      if (this.pos case var from) {
        if (this.f19() case (var $0 && var min)?) {
          if (this.f42() case var $1?) {
            if (this.f19() case (var $2 && var max)) {
      ...
      this.pos = mark;
      if (this.pos case var from) {
        if (this.f19() case (var $0 && var number)?) {
      ...
      if (this.pos case var from) {
        if (this.apply(this.r13) case (var $0 && var sep)?) {
          if (this.f65() case var $1?) {
            if (this.apply(this.r13) case (var $2 && var expr)?) {
              if (this.f61() case var $3?) {
                if (this.f57() case (var $4 && var trailing)) {
                  if (($0, $1, $2, $3, $4) case var $) {
                    if (this.pos case var to) {
          ...
          if (this.f54() case var $1?) {
            if (this.f61() case var $2?) {
              if (this.f57() case var $3?) {
                if (this.f53() case var $4?) {
                  if (this.f52() case var $5?) {
                    if (this.apply(this.r13) case (var $6 && var sep)?) {
                      if (this.f69() case var $7) {
                        if (this.apply(this.r13) case (var $8 && var body)?) {
                          if (this.f51() case var $9?) {
      ...
      if (this.pos case var from) {
        if (this.f54() case var $0?) {
          if (this.f15() case var $1?) {
            if (this.f62() case var $2?) {
              if (this.f84() case var $3) {
                if (this.f53() case var $4?) {
                  if (($0, $1, $2, $3, $4) case var $) {
                    if (this.pos case var to) {
                      return "("+ $1 +", "+ ($3 == null ?"":"{"+ $3 +"}") +")";
