...
final class PegParser extends _PegParser<ParserGenerator> {
  ...
  String? fd() {
    if (this.apply(this.rr) case var $0?) {
    ...
    if (this.pos case var mark) {
            ...
            if (this.fu() case var $3?) {
              if (this.fy() case var $4?) {
                if (this.fz() case var $5?) {
                  if (this.f20() case (var $6 && var sep)?) {
                    if (this.fh() case var $7?) {
                      if (this.f20() case (var $8 && var body)?) {
                        if (this.f10() case var $9?) {
          ...
          if (this.fq() case var $2?) {
            if (this.fy() case var $3?) {
              if (this.fz() case var $4?) {
                if (this.f20() case (var $5 && var sep)?) {
                  if (this.fh() case var $6?) {
                    if (this.f20() case (var $7 && var body)?) {
                      if (this.f10() case var $8?) {
      ...
      if (this.f1n() case var $0?) {
        if (this.fz() case var $1?) {
          if (this.f20() case (var $2 && var sep)?) {
            if (this.fh() case var $3?) {
              if (this.f20() case (var $4 && var body)?) {
  ...
  Statement? r3() {
    if (this.pos case var mark) {
      if (this.f1v() case var $0?) {
        if (this.f1z() case (var $1 && var name)) {
      ...
      this.pos = mark;
      if (this.f1z() case (var $0 && var name)) {
        if (this.fz() case var $1?) {
  ...
  Statement? r4() {
    if (this.pos case var mark) {
      ...
      this.pos = mark;
      if (this.f1w() case var $0) {
        if (this.apply(this.rs) case (var $1 && var type)?) {
          if (this.f2() case (var $2 && var name)?) {
            if (this.f3() case (var $3 && var body)?) {
              if (($0, $1, $2, $3) case var $) {
      ...
      if (this.f1w() case var $0) {
        if (this.f2() case (var $1 && var name)?) {
          if (this.fo() case var $2?) {
            if (this.apply(this.rs) case (var $3 && var type)?) {
      ...
      if (this.apply(this.ra) case var _0?) {
        if ([_0] case (var $0 && var body && var _loop2)) {
          ...
          if (this.f15() case var $1?) {
            if (this.f1x() case (var $2 && var number)?) {
              if (($0, $1, $2) case var $) {
  ...
  Node? ra() {
    if (this.pos case var mark) {
      if (this.f1z() case (var $0 && var identifier)?) {
        if (this.matchPattern(_string.$21) case var $1?) {
          if (this.fh() case var $2?) {
  ...
  Node? rb() {
    if (this.pos case var mark) {
      if (this.f1x() case (var $0 && var min)?) {
        if (this.f19() case var $1?) {
          if (this.f1x() case (var $2 && var max)) {
            if (this.f20() case (var $3 && var atom)?) {
              if (($0, $1, $2, $3) case var $) {
      ...
      this.pos = mark;
      if (this.f1x() case (var $0 && var number)?) {
        if (this.f20() case (var $1 && var atom)?) {
          if (($0, $1) case var $) {
      ...
      this.pos = mark;
      if (this.f20() case (var $0 && var sep)?) {
        if (this.fl() case var $1?) {
          if (this.f20() case (var $2 && var expr)?) {
            if (this.fq() case var $3?) {
              if (this.fu() case (var $4 && var trailing)) {
                if (($0, $1, $2, $3, $4) case var $) {
  ...
  Object? ri() {
    if (this.pos case var mark) {
      if (this.matchPattern(_string.$16) case var $0?) {
        if (this.matchPattern(_string.$32) case var $1?) {
          if (this.apply(this.rh)! case var $2) {
  ...
  /// `global::type::generic`
  String? ro() {
    if (this.apply(this.rm) case (var $0 && var base)?) {
      if (this.f14() case var $1?) {
        if (this.apply(this.rn) case (var $2 && var arguments)?) {
  ...
  String? rr() {
    if (this.fh() case var $0?) {
      if (this.apply(this.rq) case (var $1 && var nonNullable)?) {
        if (this.fh() case var $2?) {
          if (this.fu() case var $3) {
            if (($0, $1, $2, $3) case var $) {
