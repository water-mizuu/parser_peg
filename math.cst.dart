...
final class Math extends _PegParser<Object> {
  ...
  Object? ra() {
    ...
    if (this.apply(this.ra) case var term?) {
      if (this.apply(this.rd)! case var $1) {
        if (this.apply(this.rb) case var factor?) {
  ...
  Object? rb() {
    var _mark = this._mark();
    if (this.apply(this.rc) case var primary?) {
      if (this.apply(this.rd)! case var $1) {
