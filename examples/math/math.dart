...
// GENERATED CODE
final class MathParser extends _PegParser<Object> {
  MathParser();
      ...
      if (this.apply(this.r1) case (var $0 && var expr)?) {
        if (this.apply(this.r6)! case var $1) {
          if (this.matchPattern(_string.$1) case var $2?) {
            if (this.apply(this.r6)! case var $3) {
  ...
  Object? r4() {
    if (this.pos case var mark) {
      if (this.apply(this.r5) case (var $0 && var primary)?) {
        if (this.apply(this.r6)! case var $1) {
