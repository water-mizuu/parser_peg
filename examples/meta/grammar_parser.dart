...
final class GrammarParser extends _PegParser<ParserGenerator> {
  ...
  late final f1l = () {
    if (this.f4g() case var outer_decorator) {
      if (this.f6() case var name?) {
        if (this.f17() case _?) {
          if (this.fb() case _?) {
            if (this.f4h() case var inner_decorator) {
              if (this.f13() case _?) {
  ...
  late final f1m = () {
    if (this.f4j() case var outer_decorator) {
      if (this.apply(this.r11) case var type?) {
        if (this.f6() case var name?) {
          if (this.f17() case _?) {
            if (this.fb() case _?) {
              if (this.f4k() case var inner_decorator) {
                if (this.f13() case _?) {
                  if (this.apply(this.r2) case var _0?) {
                    if ([_0] case (var statements && var _l1)) {
                      for (;;) {
  ...
  late final f1n = () {
    if (this.f4m() case var outer_decorator) {
      if (this.f4n() case var type) {
        if (this.f15() case _?) {
          if (this.f14() case _?) {
            if (this.f17() case _?) {
              if (this.fb() case _?) {
                if (this.f4o() case var inner_decorator) {
                  if (this.f13() case _?) {
                    if (this.apply(this.r2) case var _0?) {
                      if ([_0] case (var statements && var _l1)) {
                        for (;;) {
  ...
  late final f1o = () {
    var _mark = this._mark();
    if (this.matchPattern(_string.$41) case var _2?) {
    ...
    this._recover(_mark);
    if (this.matchPattern(_string.$41) case var _6?) {
    ...
    this._recover(_mark);
    if (this.matchPattern(_string.$41) case var _10?) {
    ...
    this._recover(_mark);
    if (this.matchPattern(_string.$41) case var _14?) {
  ...
  Statement ? r2() {
    ...
    if (this.f1t() case var decorator) {
      if (this.f1u() case var type) {
        if (this.apply(this.r13) case var _2?) {
