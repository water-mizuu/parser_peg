...
final class GrammarParser extends _PegParser<ParserGenerator> {
  ...
  HybridNamespaceStatement? fm() {
    if (this.f36() case var outer_decorator) {
      if (this.f37() case var type) {
        if (this.apply(this.r1w) case _?) {
          if (this.apply(this.r1x) case _?) {
            if (this.apply(this.r20) case _?) {
              if (this.apply(this.r1h) case _?) {
  ...
  /// `fragment1`
  String fu() {
    if (this.apply(this.r2d)! case var $) {
      return $;
    }
  }
  ...
  /// `fragment29`
  String? f1m() {
    if (this.apply(this.r21) case var $?) {
      return $;
    }
  }
  ...
  /// `fragment44`
  String? f21() {
    if (this.apply(this.r28) case var $?) {
      return $;
    }
  }
  ...
  Object? f22() {
    var _mark = this._mark();
    if (this.apply(this.r2e) case var $?) {
      return $;
    }
    this._recover(_mark);
    if (this.matchPattern(_string.$1) case var $0?) {
      this._recover(_mark);
      if (this.apply(this.r2f) case var $1?) {
        return ($0, $1);
      }
    }
  }
  ...
  /// `fragment81`
  String? f32() {
    if (this.apply(this.r1z) case var $?) {
      return $;
    }
  }
  ...
  Node? rb() {
    ...
    if (_mark.isCut)
      ...
      this._recover(_mark);
    if (this.apply(this.r1n) case null) {
      this._recover(_mark);
      if (this.apply(this.r1r) case _?) {
        _mark.isCut = true;
        if (this.apply(this.r3) case (var $3 && var $)?) {
          if (this.apply(this.r1s) case _?) {
            if ($3 case var $) {
              return FlatNode($);
            }
          }
    ...
    if (_mark.isCut)
      ...
      this._recover(_mark);
    if (this.apply(this.r2b) case var $?) {
    ...
    this._recover(_mark);
    if (this.apply(this.r2c) case var $?) {
    ...
    this._recover(_mark);
    if (this.apply(this.r2a) case var $?) {
    ...
    this._recover(_mark);
    if (this.apply(this.r29) case var $?) {
    ...
    this._recover(_mark);
    if (this.apply(this.r1p) case var $?) {
      return const CutNode();
    }
    this._recover(_mark);
    if (this.f6() case var $?) {
  ...
  String? rx() {
    if (this.apply(this.r1t) case _?) {
      if (this.apply(this.rz) case (var $1 && var $)?) {
        if (this.f1q() case _) {
          if (this.apply(this.r1u) case _?) {
            if ($1 case var $) {
              return "[" + $ + "]";
            }
          }
  ...
  String? r2f() {
    var _mark = this._mark();
    if (this.apply(this.r2g) case var $?) {
      return $;
    }
    this._recover(_mark);
    if (this.apply(this.r2h) case var $?) {
      return $;
    }
  }
